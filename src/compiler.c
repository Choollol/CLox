...
/// @brief Adds an upvalue to the compiler's upvalue array.
/// @returns The index of the created upvalue in the compiler's upvalue array.
...
/// @brief Resolves an upvalue by searching in the given compiler's enclosing compiler.
/// @returns If an upvalue was created, the index of the created upvalue in the compiler's upvalue array. Otherwise, -1.
...
/// @brief Creates a Token from the given string.
...
/// @brief Parses a super access expression.
