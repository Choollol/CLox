...
/// @brief Native function to output seconds since the start of the program.
...
/// @brief Defines a native function in the VM's global scope.
...
/// @returns An ObjUpvalue* that closes over a local variable.
...
/// @brief Closes all upvalues that are above or equal to the given Value* on the VM's stack.
